...
import { materialCommonStyles } from "../../Constant/materialCommonStyles";
    ...
    <div className={classes.productListWrapper}>
      <div className="container" style={{width:'100%',backgroundColor:'white'}}>
        ...
        <Grid container className="title-wrapper">
          <Grid item xs={6}>
            <Typography variant="h2" style={{marginLeft:'100px'}}>
              Total
          ...
          <FormControl className="dropdown-wrapper" variant="outlined" style={{marginRight:"150px"}}>
